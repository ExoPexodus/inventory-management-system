...
class UpdateService {
  ...
  /// Starts downloading the APK silently. Shows a progress notification while
  /// downloading and a "tap to install" notification when done. If the app is
  /// still in the foreground, also shows an install dialog.
